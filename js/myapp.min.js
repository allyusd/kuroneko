...
c.resources=e.getResources();f.saveStorage("resources",c.resources)};c.resources=f.loadStorage("resources");c.resources?e.setResources(c.resources):c.resources=e.getResources();c.actions=d.getActionList();d.init();c.timer=b(c.run,a)}]);myApp=angular.module("myApp.services");
...
a&&(d.resources.imp.amount++,d.resources.soul.amount-=a,c.getImp.tip=e(10,1.2,"imp"))});a("getLand",3,"Get Land",e(100,1.2,"imp"),function(){var a=f(10,d.resources.land.amount,1.2);d.resources.soul.amount>=a&&(d.resources.land.amount++,d.resources.soul.amount-=a)})};d.getActionList=function(){return c}}]);myApp=angular.module("myApp.services");myApp.service("resources",[function(){function b(a,b){var d={};d.name=a;d.sort=b;d.amount=0;d.modify=0;return d}var a=this;a.setResources=function(b){a.resources=b};a.getResources=function(){return a.resources};a.dataReset=function(){a.resources={};a.resources.soul=b("soul",1);a.resources.imp=b("imp",2);a.resources.land=b("land",3)};a.dataReset()}]);myApp=angular.module("myApp.services");myApp.service("storage",["localstorage",function(b){var a=this;a.storage=new LocalStorage("kuroneko");a.saveStorage=function(b,e){a.storage.saveStorage(b,e)};a.loadStorage=function(b){return a.storage.loadStorage(b)};a.storage.namespace="kuroneko"}]);angular.module("myApp.directives",[]).directive("appVersion",["version",function(b){return function(a,f,e){f.text(b)}}]);angular.module("myApp.filters",[]).filter("interpolate",["version",function(b){return function(a){return String(a).replace(/\%VERSION\%/mg,b)}}]).filter("orderObjectBy",function(){return function(b,a,f){var e=[];angular.forEach(b,function(a){e.push(a)});e.sort(function(b,c){return b[a]>c[a]?1:-1});f&&e.reverse();return e}});
